...
<table>
    <tr>
        <td colspan="2" class="center bold" style="font-size:18px; padding-bottom:20px;">
            RAPOR<br>
            {{ strtoupper($namaSekolah) }}
        </td>
    </tr>
...
<table>
    ...
    <tr class="line"><td>6.</td><td>Status Dalam Keluarga</td><td>: {{ $siswa->status_dalam_keluarga ?? '-' }}</td></tr>
    ...
    <tr class="line"><td></td><td style="padding-left:20px;">a. Di Kelas</td><td>: {{ $siswa->diterima_di_kelas ?? '-' }}</td></tr>
    <tr class="line"><td></td><td style="padding-left:20px;">b. Pada Tanggal</td><td>: {{ $siswa->tanggal_diterima ?? '-' }}</td></tr>
...
<table>
      <tr>
        <td width="40%"><div class="foto">Foto Murid<br>3x4</div></td>
